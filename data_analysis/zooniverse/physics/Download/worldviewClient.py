...
def downloadMODISImgs(startDate, endDate, extent, savePath, satellite='Aqua',
                  lon2pix=111.4, lat2pix=111, exist_skip=False, 
                  var='CorrectedReflectance_TrueColor',filetype='jpeg'):
    ...
    for i in range(len(dateRange)):
        ...
        url = ('https://wvs.earthdata.nasa.gov/api/v1/snapshot?'+
               ...
               yr+'-'+mon+'-'+day+loc+'&CRS=EPSG:4326'+
               layer+'&FORMAT=image/'+filetype+size)
        save_str = (savePath+f'/{satellite}_'+var+yr+
